...
def test(FLAGS):
    ...
    loss, logits,_ = inference(test_data_node, test_labels_node, batch_size, phase_train)
    ...
    with tf.Session(config=config) as sess:
        # Load checkpoint
        ckpt = "D:/yel/goaf/lab/multi_input_dense_max_3inputs/model.ckpt-36000"
        if ckpt:
        ...
        for image_batch, label_batch in zip(images, labels):
            ...
            # if (FLAGS.save_image):
                ...
                # writeImage(im[0], 'D:/yel/goaf/test_image/3inputs/'+str(image_filenames[count]).split('\\')[-1])
