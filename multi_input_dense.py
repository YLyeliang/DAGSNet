...
tf.app.flags.DEFINE_string('finetune', 'D:\yel\goaf\log/model.ckpt-28000', """ finetune checkpoint file """)  # D:/tmp\segnet/finetune
...
tf.app.flags.DEFINE_integer('max_steps', "12000", """ max_steps """)
...
def inference(images, labels, batch_size, phase_train):
    ...
    with tf.variable_scope('decode_3'):
        cr3 = crack_refine(dense2, (7, 7), phase_train=phase_train)
    ...
    with tf.variable_scope('decode_2'):
        cr2 = crack_refine(dense1, (11, 11), phase_train=phase_train)
    ...
    with tf.variable_scope('decode_1'):
        cr1 = crack_refine(conv1, (15, 15), phase_train=phase_train)
...
def test(FLAGS):
    ...
    with tf.Session(config=config) as sess:
        # Load checkpoint
        ckpt = "D:/yel/goaf/lab/multi_input_dense_detail/model.ckpt-39000"
        if ckpt:
        ...
        for image_batch, label_batch in zip(images, labels):
            ...
            if (FLAGS.save_image):
                ...
                writeImage(im[0], 'D:/yel/goaf/test_image/multi_input_dense/'+str(image_filenames[count]).split('\\')[-1])
