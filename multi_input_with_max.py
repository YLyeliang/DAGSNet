...
tf.app.flags.DEFINE_string('log_dir', "D:/yel/goaf/lab/msi_fcn", """ dir to store ckpt """)
...
def inference(images, labels, batch_size, phase_train):
    ...
    with tf.variable_scope('decode_4'):
        ...
        conv_decode4 = conv_layer_with_bn(concat4, [3, 3, concat4.get_shape().as_list()[3], 256], phase_train, False,
                                          name="conv_decode4")
    ...
    with tf.variable_scope('decode_3'):
        ...
        conv_decode3 = conv_layer_with_bn(concat3, [3, 3, concat3.get_shape().as_list()[3], 128], phase_train, False,
                                          name="conv_decode3")
    ...
    with tf.variable_scope('decode_2'):
        ...
        conv_decode2 = conv_layer_with_bn(concat2, [3, 3, concat2.get_shape().as_list()[3], 64], phase_train, False,
                                          name="conv_decode2")
    ...
    with tf.variable_scope('decode_1'):
        ...
        conv_decode1 = conv_layer_with_bn(concat1, [3, 3, concat1.get_shape().as_list()[3], 64], phase_train, False,
                                          name="conv_decode1")
    """ end of Decode """
    """ Start Classify """
...
def test(FLAGS):
    ...
    with tf.Session(config=config) as sess:
        # Load checkpoint
        ckpt = "D:/yel/goaf/lab/msi_fcn/model.ckpt-36000"
        if ckpt:
        ...
        print("crack specificity: ", np.diag(hist)[0] / (np.diag(hist)[0]+hist[0][1]))
