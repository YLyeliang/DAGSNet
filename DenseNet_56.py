...
tf.app.flags.DEFINE_string('log_dir', "D:/yel/goaf\lab/FCN_densenet_56_detail", """ dir to store ckpt """)
...
def inference(images, labels, batch_size, phase_train):
    ...
    with tf.variable_scope('conv_classifier') as scope:
        kernel = _variable_with_weight_decay('weights',
                                             ...
                                             initializer=msra_initializer(1, 192),
                                             wd=0.0005)
...
def test(FLAGS):
    ...
    with tf.Session(config=config) as sess:
        # Load checkpoint
        ckpt = "D:/yel/goaf/lab/FCN_densenet_56_detail/model.ckpt-48000"
        if ckpt:
        ...
        for image_batch, label_batch in zip(images, labels):
            ...
            # if (FLAGS.save_image):
                ...
                # writeImage(im[0], 'D:/yel/goaf/test_image/densenet/' + str(image_filenames[count]).split('\\')[-1])
