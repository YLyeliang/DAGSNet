...
def inference(images, labels, batch_size, phase_train):
    ...
    with tf.variable_scope('atrous_SPP'):
        ...
        pool4 = conv_layer_with_bn(pool4,[1,1,pool4.get_shape().as_list()[3],64],phase_train,False,name='trainsition')
    ...
    with tf.Session(config=config) as sess:
        ...
        for image_batch, label_batch in zip(images, labels):
            ...
            if (FLAGS.save_image):
                ...
                writeImage(im[0], 'D:/tmp\crack/val_6_256_dense_block/'+str(image_filenames[count]).split('\\')[-1])
