...
def inference(x, labels, grwoth_rate=12, training=None):
    ...
    with tf.variable_scope('decoder_1'):
        l = deconv_layer(l, [2, 2, 64, 64], [BATCH_SIZE, 64, 64, 64], 2, name='deconv')
        l = conv2d(l, 64, (7, 7), (1, 1), name='conv_7x7')
    with tf.variable_scope('decoder_2'):
        l = deconv_layer(l, [2, 2, 64, 64], [BATCH_SIZE, 128, 128, 64], 2, name='deconv')
        l = conv2d(l, 64, (7, 7), (1, 1), name='conv_7x7')
    with tf.variable_scope('decoder_3'):
        l = deconv_layer(l, [2, 2, 64, 64], [BATCH_SIZE, 256, 256, 64], 2, name='deconv')
        l = conv2d(l, 64, (7, 7), (1, 1), name='conv_7x7')
